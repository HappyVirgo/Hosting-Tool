...
describe("linkedListings", () => {
    ...
    test("should add linked listing when select listing options", async () => {
        ...
        const listingSelect = screen.queryByText("Listings...").parentElement.parentElement
            .parentElement;
    ...
    test("should remove linked listing", async () => {
        ...
        const removeLikedLinkButton = screen
            .queryByText("nickname_01")
...
describe("linkedLocks", () => {
    ...
    test("should add linked lock when select listing options", async () => {
        ...
        const lockOptionSelect = screen.queryByText("Locks...").parentElement.parentElement
            .parentElement;
    ...
    test("should remove linked lock", async () => {
        ...
        const removeLinkedLockButton = screen
            .queryByText("name_01")
            .parentElement.parentElement.querySelector("button");
...
describe("selectPriceSource", () => {
    test("should change price source", async () => {
        ...
        const priceSourceSelectElement = screen.queryByText("Set Amount").parentElement
...
describe("calendarExportCode", () => {
    ...
    test("should generate new calendar export code when click button generate new url", async () => {
        ...
        expect(
            screen.getByDisplayValue("https://hosttools.com/ical/exportCalendarCode_123")
        ).toBeInTheDocument();
...
jest.mock("is-url", () => url => url === "url_calendar_valid");
...
describe("CalendarURL", () => {
    test("should add calendar url success", () => {
        ...
        fireEvent.change(screen.getByRole("textbox", {name: "Import Calendars"}), {
            target: {value: "url_calendar_valid"}
        });
    ...
    test("should not add invalid calendar url", () => {
        ...
        fireEvent.change(screen.getByRole("textbox", {name: "Import Calendars"}), {
            target: {value: "url_calendar_invalid"}
        });
